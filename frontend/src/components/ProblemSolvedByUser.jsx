...
const ProblemSolvedByUser = () => {
  ...
  return (
    <div className="p-6 bg-black/15 rounded-lg shadow-md ">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <Link to="/problems" className="btn bg-sky-700">
                  View Problems
                </Link>
              </div>
            </div>
                      ...
                      <td>
                        <div className="flex flex-wrap gap-1">
                          {problem.tags && problem.tags.map((tag, index) => (
                            <div key={index} className="badge border border-sky-500 text-sky-500 rounded-full">
                      ...
                      <td className="text-center">
                        <div className="flex justify-center">
                          <Link 
                            ...
                            className="btn btn-sm border border-sky-500 text-sky-500"
                          >
